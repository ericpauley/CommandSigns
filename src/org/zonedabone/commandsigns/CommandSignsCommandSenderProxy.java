...
/**
 * Creates a tapped link between an originator CommandSender and a recipient CommandSender
 * originator and recipient can be the same CommandSender
 * Allows sendMessage() methods to be intercepted if the silent flag is set
 */
public class CommandSignsCommandSenderProxy implements CommandSender {
    ...
    public CommandSignsCommandSenderProxy(CommandSender originator, CommandSender recipient) {
    	this(originator, recipient, false);
    }
    public CommandSignsCommandSenderProxy(CommandSender originator, boolean silent) {
        this(originator, originator, silent);
    }
    public CommandSignsCommandSenderProxy(CommandSender originator, CommandSender recipient, boolean silent) {
